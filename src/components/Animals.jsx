...
const images = import.meta.glob("../assets/animals/*.{png,jpg,jpeg,svg}");
...
const Animals = () => {
  ...
  return (
    <div className="text-white font-body bg-body">
      <div className="bg-component mt-2 mx-2 rounded-2xl max-w-full pb-10">
          ...
          {animalImages.map((image, index) => (
            ...
            >
              <div className="w-full rounded-2xl overflow-hidden">
                <img src={image} alt={`Animal ${index}`} />
              </div>
            </div>
          ))}
        </div>
