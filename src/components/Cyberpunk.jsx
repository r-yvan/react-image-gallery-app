...
const images = import.meta.glob("../assets/cyberpunk/*.{png,jpg,jpeg,svg}");

const Cyberpunk = () => {
  const [cyberpunkImages, setCyberpunkImages] = useState([]);
    ...
    <div className="text-white font-body bg-body">
      <div className="bg-component mt-2 mx-2 rounded-2xl pb-10">
        ...
        <div className="flex flex-wrap flex-row gap-10 w-full h-full pl-16">
          {cyberpunkImages.map((image, index) => (
            <div
              key={index}
            ...
            >
              <div className="w-full rounded-2xl overflow-hidden">
                <img src={image} alt={`Cyberpunk ${index}`} />
              </div>
            </div>
          ))}
        </div>
